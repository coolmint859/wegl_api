...
import { Vector2 } from "../../utilities/index.js";
import Component from "../component.js";

export default class Vec2Component extends Component {
    #vector = new Vector2();
     ...
     * @returns {Vec2Component} a new Vec2Component with the same value as this one.
     */
    clone(deepCopy = false) {
        const vector = deepCopy ? this.#vector.clone() : this.#vector;
        return new Vec2Component(vector, this.name);
    }
